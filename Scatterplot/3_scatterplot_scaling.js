// Width og height, samt padding til SVG-elementet
const w = 500;
const h = 100;
const padding =30;
...
//Labels laves på samme måde, men med "text"
svg
  .selectAll("text")
  .data(dataset)
  .enter()
  ...
  .attr("x", function (d) {
    return xScale(d[0]) + 5; // står lige 5+ op over cirklen
  })
  .attr("y", function (d) {
    return yScale(h - d[1]) - 5; //rykker 5 hen udfra cirklen
  })
