...
const yScale = d3
   ...
   * Dette skriver vi nu:
   **/
  //vender plottet om så 0.0 ligger i nedereste venstre hjørne
...
svg
  ...
  .attr("cy", function (d) {
     ...
     **/
    //behøver ikke bekømre os om h - det fixer scalaen
    return yScale(d[1]);
  })
...
// Definerer akserne til x og y (læg mærke til de to typer!):
//akser har en modtode scale
